...
public class ImagePool {
	...
	public static Animation<TextureRegion> playerAnimationDied = new Animation<TextureRegion>(0.15f,matrixDiedPlayer[0]);
	...
	public static Animation<TextureRegion> shotPlayerAnimationRight = new Animation<TextureRegion>(0.05f,matrixShot[1]);
	...
	public static Animation<TextureRegion> enemyAnimationRight = new Animation<TextureRegion>(0.15f,matrixMoveEnemy[1]);
	...
	public static Animation<TextureRegion> shotEnemyAnimationUp = new Animation<TextureRegion>(0.05f,matrixShotEnemy[0]);
	public static Animation<TextureRegion> shotEnemyAnimationRight = new Animation<TextureRegion>(0.05f,matrixShotEnemy[1]);
	public static Animation<TextureRegion> shotEnemyAnimationDown = new Animation<TextureRegion>(0.05f,matrixShotEnemy[2]);
	public static Animation<TextureRegion> shotEnemyAnimationLeft = new Animation<TextureRegion>(0.05f,matrixShotEnemy[3]);
