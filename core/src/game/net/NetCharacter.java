...
public class NetCharacter extends DynamicObject {
	 ...
	 * 
	 * @param type
	 *            indicates the type of weapon that would to increments shots
	 */
	public void addShots(String type) {
		...
		} else if (ConstantField.MAX_NUM_SHOT_SHOTGUN >= machineGunShots + AddMachineGunShots.shots)
	 ...
	 * 
	 * @param newSpeed
	 *            indicate the new values of velocity that we want set at player
	 */
